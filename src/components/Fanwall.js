...
function Fanwall(){
    ...
    let card1 = {
        name:"Yash",
        message:"Dear Akshaan, I became your fan the very first time I saw you as Veer in TMKOC. Your cuteness, innocence, and natural acting instantly won my heart. You are truly special, and I’ll always support you as you grow in your journey.",
        date: "2025-09-05",
        color:"#07FCE7"
    }
    ...
    function submitHandler(event){
        ...
        setFormData({ name:"",message:"",date:"",color:""});
                ...
                className='w-full flex gap-[15px] z-20'>
                {
                    ...
                    cards.map((card)=>(
                        <div style={{backgroundColor: card.color}}
                            className={`fanwall-card z-[200] p-[15px] pt-[20px] max-w-[300px] min-h-[150px] text-xl text-red-600 rounded-2xl relative mb-[15px]`}>
                            <img
                                className='w-[100px] rotate-[25deg] absolute top-[-25px] left-[50%] translate-x-[-50%]'
                                src={CardPin2}/>
                            <p className='text-2xl'>{card.message}</p>
                            <div className='max-w-max ml-auto mt-[8px]'>
                                <p>-{card.name}</p>
                                <p className='text-sm ml-[10px]'>{card.date}</p>
                            </div>
